...
const startLogOutTimer = function () {
  ...
  const tick = function () {
    ...
    //In each call ,pritn the remaining time to UI
...
// console.log(new Date('Aug 06 2023 21:55:46'));
...
// const calcDayPassed = (date1, date2) =>
//   Math.round(Math.abs(date2 - date1) / (1000 * 60 * 60 * 24));
// const day1 = calcDayPassed(
//   new Date(2037, 10, 19),
//   new Date(2037, 8, 5, 15, 20)
// );
// console.log(day1);

const num = 541578452.57;
const options = {
  style: 'currency',
  unit: 'celsius',
  currency: 'INR',
